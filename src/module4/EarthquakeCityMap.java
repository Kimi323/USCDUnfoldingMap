...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		else { //new Google.GoogleMapProvider() new Microsoft.HybridProvider()
		...
		// Creates Unfolding's simple markers from features. so countryMarkers is a list of markers with properties such as name.
		// // properties (e.g. name ) come from countries.geo.json
	...
	private void printQuakes() {				
		for (Marker cm : countryMarkers) {
			...
			//use getProperty method to get the name property. you can check documents for this method.
